...
router.post("/signup", async (req, res) => {
    try {
        ...
        const newUser = {
            ...
            photo: photo || "", // Default empty string if no photo provided
        };
...
router.put("/update-profile", async (req, res) => {
    try {
        const { email, full_name, phone, photo } = req.body;
        ...
        if (photo) userCollection.users[userIndex].photo = photo;
        ...
        res.json({ 
            ...
            user: userCollection.users[userIndex]
        });
    } catch (error) {
